...
from .views import data_tab, descriptive_statistics_tab, exploratory_data_analysis_tab, profile_view, export_to_csv, export_to_excel, predict_croprec
...
urlpatterns = [
    ...
    path('crop-prediction/', predict_croprec, name='predict_croprec'),
